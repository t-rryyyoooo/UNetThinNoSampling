...
class UNetSystem(pl.LightningModule):
    def __init__(self, image_path_list, label_path, criteria, in_channel_1, in_channel_2, in_channel_thin, out_channel_thin, num_class, learning_rate, batch_size, checkpoint, num_workers):
